...
class CandleEmitterScannerTest extends TestCase
{
    ...
    function testScanTwoRanges()
    {
        $source = new CandleSourceMock("mock", [
            ...
            new Candle("mock", new DateTime("Sun, 11 Jun 2017 09:22:00 +0000"), 0.8, 1.0, 0.5, 0.3, 1.1, 3.5, 4),
            new Candle("mock", new DateTime("Sun, 11 Jun 2017 09:23:00 +0000"), 0.3, 5.0, 0.2, 2.2, 1.1, 8.0, 7),
            new Candle("mock", new DateTime("Sun, 11 Jun 2017 09:28:00 +0000"), 1.0, 2.0, 0.5, 0.2, 1.1, 9.5, 5),
            new Candle("mock", new DateTime("Sun, 11 Jun 2017 09:29:00 +0000"), 0.2, 3.0, 0.1, 0.8, 1.1, 7.5, 6),
            new Candle("mock", new DateTime("Sun, 11 Jun 2017 09:30:00 +0000"), 0.8, 1.0, 0.5, 0.3, 1.1, 3.5, 4),
            new Candle("mock", new DateTime("Sun, 11 Jun 2017 09:31:00 +0000"), 0.3, 5.0, 0.2, 2.2, 1.1, 8.0, 7),
        ]);
