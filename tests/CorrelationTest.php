...
class CorrelationTest extends TestCase
{
    ...
    public function testCorrelation()
    {
        $firstSource = new CandleSourceMock("first_mock", [
            ...
            new Candle("first_mock", new DateTime("Sun, 11 Jun 2017 09:23:00 +0000"), 0.2, 3.0, 0.1, 0.8, 1.2, 7.5, 6),
        ...
        $secondSource = new CandleSourceMock("second_mock", [
            ...
            new Candle("second_mock", new DateTime("Sun, 11 Jun 2017 09:23:00 +0000"), 0.3, 5.0, 0.2, 2.2, 1.2, 8.0, 7),
        ...
        $correlation = new Correlation($aggregator, $logger);
