...
class CandleAggregatorTest extends TestCase
{
    ...
    public function testCapacityReturnsValidCountOfEmittersInAggregator()
    {
        ...
        for ($i = 0; $i < 10; $i++) {
            ...
            $aggregator->addCandleEmitter(new CandleSourceMock("first_mock", [
                new Candle("first_mock", new DateTime("Sun, 11 Jun 2017 09:20:00 +0000"), 60, 1.0, 2.0, 0.5, 0.2, 1.1, 9.5, 5),
            ]));
        }
    }
    ...
    public function testPrevsNumberEqualsHistorySize()
    {
        $firstSource = new CandleSourceMock("first_mock", [
            ...
            new Candle("first_mock", new DateTime("Sun, 11 Jun 2017 09:23:00 +0000"), 60, 0.2, 3.0, 0.1, 0.8, 1.1, 7.5, 6),
        ...
        $secondSource = new CandleSourceMock("second_mock", [
            new Candle("second_mock", new DateTime("Sun, 11 Jun 2017 09:21:00 +0000"), 60, 0.8, 1.0, 0.5, 0.3, 1.1, 3.5, 4),
            new Candle("second_mock", new DateTime("Sun, 11 Jun 2017 09:22:00 +0000"), 60, 0.3, 5.0, 0.2, 2.2, 1.1, 8.0, 7),
            new Candle("second_mock", new DateTime("Sun, 11 Jun 2017 09:23:00 +0000"), 60, 0.3, 5.0, 0.2, 2.2, 1.1, 8.0, 7),
